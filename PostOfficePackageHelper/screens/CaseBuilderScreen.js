      ...
      selectedOfficeData.office_state != null ? (
        <View>
          ...
          <View style={styles.buttonContainer}>
            <TouchableOpacity
              style={styles.button}
              onPress={handleGoToCaseView}
            >
              <Text style={styles.buttonText}>Case View</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.button}
              onPress={handleGoToListView}
            >
...
const styles = StyleSheet.create({
  ...
  buttonContainer: {
    ...
    paddingHorizontal: 20, // Add some horizontal spacing
    paddingTop: 20, // Add some top spacing
  },
  button: {
    backgroundColor: "blue", // Change the background color
    padding: 10, // Add padding to the buttons
    borderRadius: 8, // Round the button corners
  },
  buttonText: {
